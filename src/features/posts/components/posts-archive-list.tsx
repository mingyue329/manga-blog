...
function renderArchiveHeader(resultCount: number): ReactElement {
  return (
    <header data-route-enter className="relative mb-7 md:mb-8">
      <h1 className="mb-3 font-heading text-5xl font-black uppercase italic leading-none tracking-tight md:text-7xl">
        文章归档
        <br />
...
function renderPagination(
  ...
  return (
    <div data-route-enter className="mt-16 flex flex-wrap justify-center gap-3">
      {pageButtons}
...
function renderEmptyState(): ReactElement {
  return (
    <Card
      data-route-enter
      className="theme-surface-panel theme-border-strong border-4 py-0 manga-panel"
    >
