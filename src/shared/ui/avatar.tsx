...
/**
 * 澶村儚鏍圭粍浠躲€? * 铏界劧鍚嶅瓧鍙?Avatar锛屼絾褰撳墠椤圭洰浼氭妸瀹冨綋鎴愪竴涓彲瑁佸垏銆佸彲鍥為€€鐨勫浘鐗囧鍣ㄤ娇鐢ㄣ€? */
function Avatar({
  className,
  size = 'default',
  ...props
...
function AvatarBadge({ className, ...props }: React.ComponentProps<'span'>) {
  return (
    <span
      ...
      className={cn(
        'absolute bottom-0 right-0 z-10 inline-flex items-center justify-center bg-primary text-primary-foreground ring-2 ring-background select-none',
